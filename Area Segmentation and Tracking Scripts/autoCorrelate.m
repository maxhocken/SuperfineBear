...
%autoCorrelate Computes autocorrelation of provided x and y vals with a
%frequency spacing fs. 
...
%smooth data, makes analysis simpler and ignores small time scale
%flucutations. 
